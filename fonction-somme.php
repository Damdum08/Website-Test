...
<html>
        ...
        <body>
            <div class="présentation">
                    <h1> Somme Population (fonction)</h1>
                    <p> Explications </p>
            </div>
        	<table class="table-ex">
                	...
                	<tbody>
                        <?php
                            ...
                            return array("pop_fr" => $pop_fr, "pop_nl" => $pop_nl);
                            }
                            $result = somme($villes);
                            $pop_nl = $result["pop_nl"];
                            $pop_fr = $result["pop_fr"];
                            
                            echo "<tr>";
                            echo "<td>".$result["$pop_nl"]."</td>";
                            echo "<td>".$result["$pop_fr"]."</td>";
                            echo "</tr>";
						?>
	                </tbody>
        	</table>
